    ...
    <main>
      <section className="justify-content-center">
        ...
        <p>
          ...
          (ii) interfering with or disrupting any element of the Service; (iii)
          circumventing any measure we may use to prevent or restrict access to
          the Service; (iv) sending any viruses, worms, defects, Trojan horses,
          or other harmful code; (v) interfering with the proper working of the
          Service; (vi) accessing, possessing, or using any information on the
          Service in violation of our Privacy Policy; (vii) requesting,
          possessing, or using any login information or credentials of another
          user; (viii) impersonating any person or entity; (ix) using the
          Service for any illegal purpose, or in violation of any applicable law
          or regulation.
        </p>
        <h3>User Content</h3>
        <p>
          Any content that you submit to the Service is your "User Content". You
          retain all ownership rights in your User Content. However, by
          ...
          and otherwise exploit your User Content in connection with the Service
          and our business. You also agree that we may publish your name in
        ...
        <p>
          ...
          permissions to use such content and to grant us the license set forth
          above; (ii) your User Content does not infringe any third party's
          intellectual property rights or other rights; and (iii) your User
        ...
        <p>
          ...
          copyright or trademark laws. You agree that you must evaluate and bear
        ...
        <p>
          We respect the intellectual property rights of others, and we require
          that users of the Service do the same. If you believe that your work
          has been copied in a way that constitutes copyright infringement,
          please provide us with the following information: (i) an electronic or
          physical signature of the person authorized to act on behalf of the
          owner of the copyright interest; (ii) a description of the copyrighted
          work that you claim has been infringed; (iii) a description of where
          ...
          and (vi) a statement by you, made under penalty of perjury, that the
        ...
        <p>
          ...
          description of the trademark that you claim has been infringed; (iii)
          a description of where the material that you claim is infringing is
          located on the Service; (iv) your address, telephone number, and email
          address; (v) a statement by you that you have a good faith belief that
          the disputed use is not authorized by the trademark owner, its agent,
          ...
          trademark. Our Trademark Agent for notice of claims of trademark
          infringement can be reached as follows:
        </p>
        <p>siteseers@gmail.com</p>
        <h3>Indemnity</h3>
        <p>
          You agree to indemnify and hold us harmless from any claims, disputes,
          demands, liabilities, damages, losses, and costs and expenses,
          including without limitation reasonable attorneys' fees and costs,
          arising out of or in any way connected with: (i) your access to or use
          of the Service; (ii) your User Content; or (iii) your violation of
          these Terms.
        </p>
        <h3>Disclaimers</h3>
        <p>
          ...
          non-infringement. We make no warranty that: (i) the service will meet
        ...
        <p>
          ...
          damages. Under no circumstances shall our liability to you exceed one
          thousand U.S. dollars ($1,000). The foregoing limitations will apply
        ...
        <p>
          ...
          hereunder, and any such attempt is voidable at our option. We have the
          right to assign these Terms and to delegate, license or otherwise
          transfer our rights and/or obligations hereunder without your consent.{" "}
        </p>
        <h3>Severability</h3>
        <p>
          If any provision of these Terms is held by a court of competent
          jurisdiction to be illegal, void or unenforceable, the provision shall
        ...
        <h3>Dispute Resolution; Binding Arbitration; Class Action Waiver</h3>
        <p></p>
        <h3>Waiver</h3>
        <p>
        ...
        <p>
          ...
          referenced herein constitute the sole and entire agreement between you
          and us with respect to the Service and supersede all prior and
        ...
        <p>
          ...
          Any changes will be effective upon our posting of revised Terms on the
          Site. Your continued use of the Service following the posting of
          revised Terms means that you accept and agree to the changes.
        </p>
        <h3>Contacting Us </h3>
        <p>
          If you have any questions, please contact us at: siteseers@gmail.com.
        </p>
      </section>
    </main>
  );
